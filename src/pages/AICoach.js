...
export default function AICoach() {
  ...
  return (
    <div className="page">
      <h1 className="syne" style={{ fontSize: 24, fontWeight: 800, marginBottom: 6 }}>
        AI Performance Coach
      </h1>

      <p style={{ color: 'var(--muted)', fontSize: 14, marginBottom: 28 }}>
        Analyzes your channel and gives personalized growth tips.
      </p>
      ...
      {!result ? (
        <div className="glass" style={{ padding: 32, textAlign: 'center' }}>
          ...
          <div className="syne" style={{ fontSize: 18, fontWeight: 700, marginBottom: 8 }}>
            Ready to analyze your channel?
          </div>

          <p style={{ color: 'var(--muted)', fontSize: 14, marginBottom: 24 }}>
            We'll look at your videos and generate 3 actionable tips using Gemini AI.
          </p>
        ...
        <div>
          ...
          {result.tips?.map((t, i) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <span className="syne" style={{ fontWeight: 700, fontSize: 15 }}>
                  {t.title}
                </span>
              </div>
          ...
          <div
            className="glass-sm"
            style={{ padding: '14px 18px', marginTop: 16, display: 'flex', alignItems: 'center', gap: 12 }}
          >
          ...
          <div
            className="glass-sm"
            style={{ padding: '14px 18px', marginTop: 10, display: 'flex', alignItems: 'center', gap: 12 }}
          >
            <span style={{ fontSize: 18 }}>⏰</span>
            <div>
